...
export const generateConsecutiveBlock = (parentBlock: Block, difficultyChangeFactor: number): Block => {
  ...
  block.header.timestamp = toBuffer(bufferToInt(parentBlock.header.timestamp) + (10 + (-difficultyChangeFactor*9)))
